            ...
            <form method="POST" action="{{ route('posts.store') }}"
                ...
                <div class="mb-6">
                    ...
                    <input required name="title"
                           class="shadow appearance-none border {{$errors->first('title') ? 'border-red-500' : null}} border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-2 leading-tight focus:outline-none focus:shadow-outline"

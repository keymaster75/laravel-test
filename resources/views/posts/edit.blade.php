            ...
            <form method="POST" action="{{ route('posts.update', $post) }}"
                ...
                <div class="mb-6">
                    ...
                    <input name="title" required
                           ...
                           id="post-title" type="text" value="{{ old('title', $post->title) }}">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="content" required id="post-content"
                              class="drop-shadow-lg w-full h-60 p-4 border {{ $errors->first('content') ? 'border-red-500' : null }} focus:outline-none focus:shadow-outline">{{ old('content', $post->content) }}</textarea>
